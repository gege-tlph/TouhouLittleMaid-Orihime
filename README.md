# Touhou Little Maid: Orihime — Minecraft 1.21.11 Fabric 移植

> [!IMPORTANT]
> 这是 [Sh1roCu/TouhouLittleMaid-Orihime](https://github.com/Sh1roCu/TouhouLittleMaid-Orihime)
> 的非官方后续移植，目标平台为 **Minecraft 1.21.11 + Fabric**。
> 本分支以其 Minecraft 1.21.1 Fabric 实现为行为基准，不代表原模组官方版本。
...
将本模组及必要前置放入客户端和服务器的 `mods` 目录。表中版本是当前 Beta 构建和测试所用的
...
- Minecraft 1.21.11 维护 fork：[gege-tlph/TouhouLittleMaid-Orihime](https://github.com/gege-tlph/TouhouLittleMaid-Orihime)
