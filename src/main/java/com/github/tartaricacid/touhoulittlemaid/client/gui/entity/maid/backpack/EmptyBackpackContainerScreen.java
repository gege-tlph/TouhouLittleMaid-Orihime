...
public class EmptyBackpackContainerScreen extends AbstractMaidContainerGui<EmptyBackpackContainer> implements IBackpackContainerScreen {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTicks, int x, int y) {
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, BACKPACK, leftPos + 190, topPos + 62, (float) 165, (float) 0, 11, 11, 256, 256);
        graphics.fill(leftPos + 142, topPos + 81, leftPos + 250, topPos + 117, 0xaa222222);
        graphics.blit(RenderPipelines.GUI_TEXTURED, BACKPACK, leftPos + 190, topPos + 92, (float) 165, (float) 0, 11, 11, 256, 256);
        graphics.fill(leftPos + 142, topPos + 122, leftPos + 250, topPos + 158, 0xaa222222);
        graphics.blit(RenderPipelines.GUI_TEXTURED, BACKPACK, leftPos + 190, topPos + 133, (float) 165, (float) 0, 11, 11, 256, 256);
    }
}
