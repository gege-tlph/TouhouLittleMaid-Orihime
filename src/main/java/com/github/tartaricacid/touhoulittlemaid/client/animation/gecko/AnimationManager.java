...
public final class AnimationManager {
    ...
    public static PlayState predicateMagicCastingAnimation(AnimationEvent<GeckoMaidEntity<?>> event) {
        ...
        for (IMagicCastingAnimationProvider provider : MagicCastingAnimationManager.getProviders()) {
            ...
            var currentPhase = state == null
                    ? IMagicCastingState.CastingPhase.NONE
                    : state.getCurrentPhase();
            if (currentPhase == IMagicCastingState.CastingPhase.NONE) {
                if ((lastPhase == IMagicCastingState.CastingPhase.INSTANT
                        || lastPhase == IMagicCastingState.CastingPhase.END)
            ...
            var builder = provider.getAnimationBuilder(maid, state);
            if (builder != null && builder.animationName() != null) {
                if (lastPhase != IMagicCastingState.CastingPhase.START
                        && lastPhase != IMagicCastingState.CastingPhase.CASTING) {
