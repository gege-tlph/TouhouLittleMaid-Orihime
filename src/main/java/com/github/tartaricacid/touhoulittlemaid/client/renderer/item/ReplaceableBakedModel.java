...
public final class ReplaceableBakedModel extends WrapperBakedItemModel {
    ...
    public static final class Unbaked extends WrapperUnbakedItemModel {
        ...
        @Override
        public ItemModel bake(ItemModel.BakingContext context, org.joml.Matrix4fc transform) {
            // 26.1.2：Unbaked.bake 增加 Matrix4fc 变换参，原样透传给两半
            return new ReplaceableBakedModel(wrapped.bake(context, transform), replacement.bake(context, transform), replace);
        }
    }
}
