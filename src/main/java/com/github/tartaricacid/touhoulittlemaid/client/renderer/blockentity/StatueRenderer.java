...
public class StatueRenderer implements BlockEntityRenderer<TileEntityStatue, StatueRenderState> {
    ...
    private void extractEntityRenderState(TileEntityStatue te, StatueRenderState state, CompoundTag data,
        ...
        if (type.equals(InitEntities.MAID)) {
            ...
            entity = EntityCacheUtil.getEntity(type, (l, level1) ->
    ...
    public void submit(StatueRenderState state, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState camera) {
        ...
        collector.submitModel(
                this.baseModel, Unit.INSTANCE, poseStack, RenderTypes.entityCutoutNoCull(TEXTURE),
