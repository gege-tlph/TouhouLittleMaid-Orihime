...
public class BaubleContainerScreen extends AbstractMaidContainerGui<BaubleContainer> implements IBackpackContainerScreen {
    ...
    protected void renderBg(GuiGraphics graphics, float partialTicks, int x, int y) {
        ...
        graphics.blit(RenderPipelines.GUI_TEXTURED, BAUBLE_BG, leftPos + 85, topPos + 36, (float) 0, (float) 0, 165, 128, 256, 256);
        ...
        if (favorabilityLevel < 2) {
            ...
            graphics.blit(RenderPipelines.GUI_TEXTURED, BAUBLE_BG, leftPos + 190, topPos + 92, (float) 165, (float) 0, 11, 11, 256, 256);
        }
        if (favorabilityLevel < 3) {
            graphics.fill(leftPos + 152, topPos + 117, leftPos + 240, topPos + 151, 0xaa222222);
            graphics.blit(RenderPipelines.GUI_TEXTURED, BAUBLE_BG, leftPos + 190, topPos + 127, (float) 165, (float) 0, 11, 11, 256, 256);
        }
    }
