...
public class TouhouImageButton extends Button {
    ...
    public void renderTexture(GuiGraphics pGuiGraphics, Identifier pTexture, int pX, int pY, int pUOffset, int pVOffset, int p_283472_, int pWidth, int pHeight, int pTextureWidth, int pTextureHeight) {
        int i = pVOffset;
        if (!this.isActive()) {
        ...
        pGuiGraphics.blit(RenderPipelines.GUI_TEXTURED, pTexture, pX, pY, pUOffset, i, pWidth, pHeight, pTextureWidth, pTextureHeight);
    }
}
