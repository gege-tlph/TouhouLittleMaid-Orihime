...
public class JadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        ...
        registration.registerItemStorage(AltarProvider.INSTANCE, BlockEntityAltar.class);
        registration.registerItemStorage(PicnicMatProvider.INSTANCE, BlockEntityPicnicMat.class);
    }
}
