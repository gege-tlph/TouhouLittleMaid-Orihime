 ...
 * 但本树的 {@code MaidBaseAnimation} 已改成渲染状态驱动（{@code IAnimation<EntityMaidRenderState>}），
 * 手上拿的是 {@link BedrockPart}、且拿不到实体本身。基准也只用实体取了一次主手物品，
 * 故这里直接收主手 {@link ItemStack}；旋转角逐字照抄基准，{@code setRotateAngleX/Y} 对应 {@code xRot/yRot}。
 */
