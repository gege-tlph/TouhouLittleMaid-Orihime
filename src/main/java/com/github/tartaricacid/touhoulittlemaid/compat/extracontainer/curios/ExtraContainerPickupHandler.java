...
public class ExtraContainerPickupHandler {
    ...
    private static void handlePickupEffects(EntityMaid maid, ItemEntity itemEntity, ItemStack remaining, int originCount) {
        ...
        MaidPickupEvent.ITEM_RESULT_POST.invoker().onItemResultPost(new MaidPickupEvent.ItemResultPost(maid, pickedStack));
