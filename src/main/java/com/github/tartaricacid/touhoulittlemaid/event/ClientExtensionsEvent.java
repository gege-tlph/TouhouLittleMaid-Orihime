...
/*        event.registerBlock(BlockAltar.CLIENT_BLOCK_EXTENSIONS, InitBlocks.ALTAR);
        ...
        event.registerItem(ItemChair.ITEM_EXTENSIONS, InitItems.CHAIR);
        event.registerItem(ItemEntityPlaceholder.ITEM_EXTENSIONS, InitItems.ENTITY_PLACEHOLDER);
        event.registerItem(ItemGarageKit.ITEM_EXTENSIONS, InitItems.GARAGE_KIT);
        event.registerItem(ItemPicnicBasket.ITEM_EXTENSIONS, InitItems.PICNIC_BASKET);*/
