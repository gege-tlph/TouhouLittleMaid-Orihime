...
public class BaseAdvancement {
    public static void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> saver) {
        ...
        generateAltar(provider, saver, root);
    ...
    private static void generateAltar(HolderLookup.Provider provider, Consumer<AdvancementHolder> saver, AdvancementHolder root) {
        ...
        EntityPredicate.Builder predicate = EntityPredicate.Builder.entity().of(provider.lookupOrThrow(Registries.ENTITY_TYPE), InitEntities.FAIRY);
