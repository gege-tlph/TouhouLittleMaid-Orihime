...
/**
 * An implementation of {@code ResourceHandler<ItemVariant>} for vanilla's {@link Container}.
 *
 ...
 */
public class VanillaContainerWrapper implements ResourceHandler<ItemVariant> {
    /**
    ...
    /**
     * Wraps a vanilla container into a {@link ResourceHandler} of {@link ItemVariant}s.
     *
     ...
     */
    public static ResourceHandler<ItemVariant> of(Container container) {
    ...
    class SlotWrapper extends ItemStackResourceHandler {
        ...
        SlotWrapper(int index) {
            this.index = index;
            this.specialContainer = container instanceof SpecialLogicContainer special ? special : null;
        }
        ...
        public int insert(int index, ItemVariant resource, int amount, TransactionContext transaction) {
            ...
            if (inserted > 0 && specialContainer != null) {
                specialContainer.fabric_onTransfer(this.index, transaction);
            }
            return inserted;
        }
        ...
        public int extract(int index, ItemVariant resource, int amount, TransactionContext transaction) {
            ...
            if (extracted > 0 && specialContainer != null) {
                specialContainer.fabric_onTransfer(this.index, transaction);
            }
            return extracted;
        }
