...
public abstract class StacksResourceHandler<S, T extends TransferVariant<?>> implements ResourceHandler<T>, ValueIOSerializable {
     ...
     * In the case of an {@link ItemStack} an {@link ItemVariant} would be returned for example.
     */
     ...
     *
     * <p>If the stack {@linkplain ResourceHandlerUtil#isBlank(TransferVariant, int)}  would be empty},
     ...
     *
     * <p>If using an immutable stack type such as {@link net.fabricmc.fabric.api.transfer.v1.storage.base.ResourceAmount}, it can be returned as is.
    ...
    public long getCapacityAsLong(int index, T resource) {
        Objects.checkIndex(index, size());
        return resource.isBlank() || isValid(index, resource) ? getCapacity(index, resource) : 0;
    }
