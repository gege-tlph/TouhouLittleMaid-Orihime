 ...
 */
public final class EmptyResourceHandler<T extends TransferVariant<?>> implements ResourceHandler<T> {
    ...
    public static <T extends TransferVariant<?>> EmptyResourceHandler<T> instance() {
