 ...
 */
public class RangedResourceHandler<T extends TransferVariant<?>> extends DelegatingResourceHandler<T> {
    /**
     ...
     */
    public static <T extends TransferVariant<?>> RangedResourceHandler<T> of(ResourceHandler<T> delegate, int start, int end) {
     ...
     * @param end   end of the range of indices, exclusive
     */
    public static <T extends TransferVariant<?>> RangedResourceHandler<T> of(Supplier<ResourceHandler<T>> delegate, int start, int end) {
        return new RangedResourceHandler<>(delegate, start, end);
    }
     ...
     */
    public static <T extends TransferVariant<?>> RangedResourceHandler<T> ofSingleIndex(ResourceHandler<T> delegate, int index) {
     ...
     */
    public static <T extends TransferVariant<?>> RangedResourceHandler<T> ofSingleIndex(Supplier<ResourceHandler<T>> delegate, int index) {
        return new RangedResourceHandler<>(delegate, index, index + 1);
    }
